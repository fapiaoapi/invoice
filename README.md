...
* [获取授权](#api1 "获取授权")
* [登录数电发票平台](#api2 "登录数电发票平台")
* [获取人脸二维码](#api3 "获取人脸二维码")
* [获取人脸二维码认证状态](#api4 "获取人脸二维码认证状态")
* [获取认证状态](#api5 "获取认证状态")

发票开具

* [数电蓝票开具接口](#api6 "数电蓝票开具接口")
* [获取销项数电版式文件](#api7 "获取销项数电版式文件")

发票红冲

* [数电申请红字前查蓝票信息接口](#api8 "查蓝票信息接口")
* [申请红字信息表](#api9 "申请红字信息表")
* [数电票开负数发票](#api10 "数电票开负数发票")

  其他接口
  * [切换电子税务局账号](#api11 "切换电子税务局账号")
  * [授信额度查询](#api12 "授信额度查询")
  其他
  * [code详情](#code-details)
  * [附件 1: 标准单位](#appendix1)
  * [附件 2: 增值税特殊管理](#appendix2)
  * [附件 3: 特定要素类型代码](#appendix3)
  * [附件 4: 发票类型代码](#appendix4)
  * [附件 5: 红字信息表状态代码](#appendix5)
  * [附件 6: 数电纸质发票票种代码](#appendix6)
  * [附件 7: 差额凭证类型](#appendix7)
  * [附件 8: 不动产单位](#appendix8)
  * [附件 9: 身份证类型](#appendix9)
  * [附件 10: 出行工具类型](#appendix10)
  * [附件 11: 出行工具类型等级](#appendix11)
  * [附件 12: 运输工具种类](#appendix12)
  * [附件 13: 国籍类型](#appendix13)
  * [附件 14: 农产品收购证件类型](#appendix14)
  * [附件 15: 发票状态类型](#appendix15)
  * [附件 16: 申请额度审核状态](#appendix16)
  * [附件 17: 国籍](#appendix17)
  * [附件 18: 支付渠道代码](#appendix18)
